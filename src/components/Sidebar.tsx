...
const Sidebar = ({ onClose }: SidebarProps) => {
  ...
  return (
    <div className="w-64 bg-card h-screen flex flex-col shadow-lg lg:rounded-r-3xl overflow-hidden">
      <div className="p-6 flex flex-col h-full">
        ...
        <div className="flex-shrink-0 mt-4">
          <Button 
            variant="ghost" 
            className="w-full justify-start h-12 text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-accent"
          >
